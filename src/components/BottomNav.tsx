            ...
            >
              {isActive && (
                <motion.div
                  ...
                  style={{ background: 'linear-gradient(90deg, #D4AF37, rgba(212,175,55,0.3))', boxShadow: '0 0 8px rgba(212,175,55,0.4)' }}
              ...
              >
                <Icon size={22} className={isActive ? 'text-gold-500' : 'text-white/30'} strokeWidth={isActive ? 2.5 : 1.5} />
              </motion.div>
              <span className={`text-[10px] mt-0.5 font-medium ${isActive ? 'text-gold-500' : 'text-white/30'}`}>{tab.label}</span>
